package me.p829911.practice.spring.security.config;

import javax.annotation.PostConstruct;
import lombok.RequiredArgsConstructor;
import me.p829911.practice.spring.security.note.NoteService;
import me.p829911.practice.spring.security.notice.NoticeService;
import me.p829911.practice.spring.security.user.User;
import me.p829911.practice.spring.security.user.UserService;
...
public class InitializeDefaultConfig {
    ...
    public void initializeDefaultAdmin() {
        ...
        noticeService.saveNotice("노트 작성 방법 공지",
